...
<section>
    <div class="container-fluid">
        <div class="main-wrapper">
                    ...
                    <div class="casinotrap-table blue-dark-bg">
                        <div class="casino-video">
                            <div class="video-block">
                                <iframe src="{{$casino->casino_link}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen  frameborder="0" allowtransparency="yes" scrolling="no" marginwidth="0" marginheight="0"></iframe>
                            </div>
                        ...
                        <div class="mobile_res_data">
                            ...
                            <div class="casino_rules_table mt-2 d-lg-none">
            ...
            <div class="casino_right_side showForm" style="display: none;">
                <form class="">
                    <div class="casinolay_bettitle black-bg-2 text-color-white">
                        <span>Place Bet</span>
