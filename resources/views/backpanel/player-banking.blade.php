...
<section class="balance-section">
	<div class="container">
        ...
        <div class="mainbalance-section">
			...
			<form action="{{route('addPlayerBanking')}}" method="post" name="frmbanking" id="frmbanking">
                <table class="table custom-table balance-table white-bg text-color-blue-2 search-result">
                    <thead>
                        <tr>
                            <th class="light-grey-bg">PlayerID <i class="fas fa-sort-down"></i></th>
                    ...
                    <tbody>
                        ...
                        <?php
							...
							$available_balance=$credit_data['remain_bal']-$credit_data['exposure'];
                        ...
                        <tr>
                            ...
                            <td class="white-bg">
                                <div class="credit-amount" id="credit_amount_div{{$i}}">
                                    ...
                                    <input type="hidden" name="playerid_banking[{{$i}}]" id="playerid_banking{{$i}}" value="{{$players->id}}" />
                            ...
                            <!-- ss comment -->
                            <!-- <td class="white-bg text-color-green">{{$balance}}</td> -->
                            <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="pagination-wrap mb-4">
                    <ul class="pages">
                        <li id="prev">
                            <a class="disable disable-bg disable-color">Prev</a>
                        </li>
                        <li id="pageNumber">
                            <a class="active text-color-yellow">1</a>
                        </li>
                        <li id="next">
                            <a class="">Next</a>
                        </li>
