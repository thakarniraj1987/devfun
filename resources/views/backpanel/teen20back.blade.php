    ...
    <div class="container-fluid">
        <div class="main-wrapper">
                ...
                <div class="middle-wraper">
                    <div class="casinotrap-table blue-dark-bg">
                            ...
                            <div class="casinocards">
                                ...
                                <div class="casinocards-container">
                                    <div class="card_con" id="casinoCarda">
                                        <span class="text-color-white"><img src=" {{ URL::to('asset/front/img/ADD.png') }}"></span>
                                        <span class="text-color-white"><img src=" {{ URL::to('asset/front/img/2CC.png') }}"></span>
                                        <span class="text-color-white"><img src=" {{ URL::to('asset/front/img/6SS.png') }}"></span>
                                    </div>
                                    <div class="card_con" id="casinoCardb">
                                        <span class="text-color-white"><img src="{{ URL::to('asset/front/img/QCC.png') }}"></span>
                                        <span class="text-color-white"><img src="{{ URL::to('asset/front/img/2CC.png') }}"></span>
                                        <span class="text-color-white"><img src="{{ URL::to('asset/front/img/2DD.png') }}"></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mobile_res_data">
                            <div class="casinolast_results mb-3 d-md-none" id="last_result">
                                <a href="our-casino-results.php" class="resultmore text-color-white">...</a>
                            </div>
                            <div class="casino_rules_table d-md-none">
            ...
            <div class="casino_right_side">
                ...
                <div class="casino_rules_table mt-4 d-none d-lg-block">
                    <div class="casinolay_bettitle black-bg-2 text-color-white">
                        <span>Rules</span>
                    </div>
                    <div class="table-responsive">
...
<div class="modal golden_modal1 current_modal fade p-0" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
