					...
					{				 
						...
						if(@$match_data[0]['status']=='OPEN')
						{
							if(isset($match_data[0]['runners'][0]['ex']['availableToBack'][2]['price']))
							{
								...
								<tr class="white-key tr_team1 mobile_bet_model_div" id="mobile_tr">
						...
						if(@$match_data[0]['status']=='OPEN')
						{
							if(isset($match_data[0]['runners'][1]['ex']['availableToBack'][2]['price']))
							{
								...
								<tr class="white-key tr_team2 mobile_bet_model_div" id="mobile_tr">
						...
						if(@$match_data[0]['status']=='OPEN')
						{
							if($section>2)
							{
								...
								<tr class="white-key tr_team3 mobile_bet_model_div" id="mobile_tr">
				...
				else
				{
					if(isset($match_data['bm'][$team1_name]['status']) && $match_data['bm'][$team1_name]['status']!='SUSPENDED')
					{
						...
						<tr class="white-bg tr_bm_team1">
							...
							<tr class="white-key tr_team1_BM mobile_bet_model_div" id="mobile_tr">
					...
					<tr class="white-key tr_team2_BM mobile_bet_model_div" id="mobile_tr">
					...
					if(isset($match_data['bm'][$team3_name]['status']))
					{
						if(@$match_data['bm'][$team3_name]['status']!='SUSPENDED')
						{
							...
							<tr class="white-key tr_team3_BM mobile_bet_model_div" id="mobile_tr">
					...
					if($match_f=='0')
					{
						...
						if($gstatus[$sid[$i]]!='Ball Running' &&  $gstatus[$sid[$i]]!='Suspended' && $l[$sid[$i]]!=0 && round($b[$sid[$i]])!=0)
						{
							if($l[$sid[$i]]!=0 && round($b[$sid[$i]])!=0 && $l[$sid[$i]]!='' && $b[$sid[$i]]!='' )
							{
								...
								<tr class="white-key tr_team'.$i.'_fancy mobile_bet_model_div" id="mobile_tr">
